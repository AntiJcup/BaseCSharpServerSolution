...
namespace BaseApi.Services.Common
{
    ...
    public class AuthAccessService
    {
        ...
        public AuthAccessService(IConfiguration configuration, AuthLayerInterface authLayer)
        {
            ...
            useAWS_ = configuration_.GetSection(BaseApi.Constants.Common.Configuration.Sections.SettingsKey)
                        .GetValue<bool>(BaseApi.Constants.Common.Configuration.Sections.Settings.UseAWSKey, false);

            localAdmin_ = configuration_.GetSection(BaseApi.Constants.Common.Configuration.Sections.SettingsKey)
