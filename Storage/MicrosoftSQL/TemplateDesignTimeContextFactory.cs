...
{
    public abstract class TemplateDesignTimeContextFactory<TDBContext> : IDesignTimeDbContextFactory<TDBContext> where TDBContext : TemplateMicrosoftSQLDbContext, new()
    {
